...
class Trip (models.Model):
    ...
    loadedQuantity = models.IntegerField ('Naložené množství', max_length=20, blank=True, null=True,)
    unloadedQuantity = models.IntegerField ('Vyložené množství', max_length=20, blank=True, null=True,)
