...
class Trip (models.Model):
    ...
    loadedQuantity = models.DecimalField ('Naložené množství', max_digits=6, decimal_places=2, blank=True, null=True,)
    unloadedQuantity = models.DecimalField ('Vyložené množství', max_digits=6, decimal_places=2, blank=True, null=True,)
    deliveryNumber = models.IntegerField ('Č. dodacího listu', max_length=10, unique=True, blank=True, null=True,)
